...
my %expts = (
	'baseline' => "-alg1::enable 0 -alg1::brupdate 0 -alg1::brhistory 0 -alg1::brupdate_cond 0 -max:inst ${inst_cnt} ",
	'bu0c0' =>    "-alg1::enable 1 -alg1::brupdate 0 -alg1::brhistory 0 -alg1::brupdate_cond 0 -max:inst ${inst_cnt} ",
	'bu1c0' =>    "-alg1::enable 1 -alg1::brupdate 1 -alg1::brhistory 0 -alg1::brupdate_cond 0 -max:inst ${inst_cnt} ",
	'bu0c1' =>    "-alg1::enable 1 -alg1::brupdate 0 -alg1::brhistory 0 -alg1::brupdate_cond 1 -max:inst ${inst_cnt} ",
	'bu1c1' =>    "-alg1::enable 1 -alg1::brupdate 1 -alg1::brhistory 0 -alg1::brupdate_cond 1 -max:inst ${inst_cnt} ",
